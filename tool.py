...
timee=time.asctime()
O = '\033[0;37m'
Le = pyfiglet.figlet_format(' Claimer [+] ')
print(O+Le)
...
def Lev ():
  ...
  while True:
     ...
     user4 = str("".join(random.choice(heros1)for x in range(1)))
     user5 = (user1+'.'+user2+user3)
     user6 = (user1+user2+'_'+user3)
     user7 = (user1+user1+user2+user1)
     user8 = (user1+user2+user3+user4)
     user9 = (user1+'_'+user2+user3)
     user10 = (user1+'.'+user2+user3)
     user11 = (user1+'_'+'_')
     user12 = (user1+'.'+user2)
     user13 = (user1+user2+'_')
     user14 = (user1+'.'+user2+user2)
     user16 = (user2+'_'+user2+'_')
     user15 = (user1+'_'+user2+'_')
     user19 = (user1+user2+user3)
     user17 = (user4+user4+'.'+user4+user4)
     user18 = (user4+user4+'_'+user4)
     heros= (user5, user6, user7, user8, user9, user10, user11, user12, user13, user14, user15, user16, user17, user18, user19)
     ...
     if '"statusCode":10221,' in reqsnd:
             print(f'\033[0;32m username Available > {user}')
             requests.post(f"https://api.telegram.org/bot{token}/sendMessage?chat_id={id}&text=New username Climed!!\nUsername : {user}\nme? @hostlist")
     else:
      print(f'\033[0;31m username Not Available > {user}')
Threads=[] 
for t in range(1):
